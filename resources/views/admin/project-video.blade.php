            ...
            <div class="kanan d-flex flex-column align-items-center" style="padding: 40px; padding-top: 50px; width: 75%; background-color: white; border-radius: 40px; ">
                <div class="element1 d-flex" style="width: 90%; border-radius: 60px; box-shadow: -2px 5px 10px rgba(0, 0, 0, 0.5); padding: 50px;  padding-left: 0; padding-bottom: 100px;">
                    ...
                    <div class="element1-kanan w-100">
                        ...
                        <p>Uploading Video Project</p>
                        <button onclick="window.location.href = '/admin/upload-project/video'" class="btn bg-dark text-light" style="width: 300px; margin-top: 20px; border-radius: 20px;">Add Project</button>
                                ...
                                <tbody>
                                    @foreach ($project as $index=>$p)
                                        <tr>
                                            ...
                                            <td>
                                            <a class="btn btn-dark" href="/admin/project/delete/video/{{$p->Project_id}}" onclick="return confirm('Anda yakin ingin menghapus project ini ?')">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                              </table>
