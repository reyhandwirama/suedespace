            ...
            <div class="kanan d-flex flex-column align-items-center" style="padding: 40px; padding-top: 50px; width: 75%; background-color: white; border-radius: 40px; ">
                <div class="element1 d-flex" style="width: 90%; border-radius: 60px; box-shadow: -2px 5px 10px rgba(0, 0, 0, 0.5); padding: 50px;  padding-left: 0; padding-bottom: 100px;">
                    ...
                    <div class="element1-kanan w-100">
                        <h5><strong>Kelola Akun Admin</strong></h5>
                        <p>Kelola akun admin untuk login</p>
                        <button onclick="window.location.href = '/admin/kelola-admin/create'" class="btn bg-dark text-light" style="width: 300px; margin-top: 20px; border-radius: 20px;">Tambah Akun</button>
                            ...
                            <div class="table-responsive">
                              <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <a href="/admin/kelola-admin/{{$a->id}}/edit" class="btn btn-dark">Edit</a>
                                      <a href="/admin/kelola-admin/{{$a->id}}/delete" onclick="return confirm('Anda yakin ingin menghapus akun ini ?')" class="btn btn-dark">Delete</a>
                                    </td>
                                  </tr>
                                @endforeach
