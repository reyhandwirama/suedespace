<div class="kiri" style="width: 20%; padding: 20px;border-radius: 40px; background-color: white; height: 90vh;">
    <div class="header-content d-flex justify-content-between w-100 p-2 flex-column-reverse" style="border-bottom: 1px solid grey; ">
    ...
    <nav class="sidebar py-2 mb-4">
        <ul class="nav flex-column" id="nav_accordion">
            <li class="nav-item">
                <a class="nav-link" href="/admin/dashboard-admin"><i class="fa-solid fa-house" style="margin-right: 5px;"></i> <strong>Home</strong></a>
            </li>
            <li class="nav-item has-submenu">
                ...
                <ul class="submenu collapse">
                    <li><a class="nav-link" href="/admin/project">Project Photo</a></li>
                    <li><a class="nav-link" href="/admin/project/video">Project Video</a></li>
                </ul>
            </li>
            <li class="nav-item">
